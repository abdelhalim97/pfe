...
<div class="container">
  ...
  <div class="collapse navbar-collapse " id="navbarSupportedContent">
    <ul class="navbar-nav justify-content-around" style="width:100%">
      <li class="nav-item">
        <a class="nav-link" href="/login">Login as user </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/admin/login">Login as admin</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" id="active" href="/moderator/login">Login as moderator</a>
      </li>
      <li class="nav-item">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('moderator.password.request') }}">
